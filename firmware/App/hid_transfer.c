...
static uint8_t hid_rx_buff[64] __ALIGNED(4);
...
static uint8_t  USB_Request [DAP_PACKET_COUNT][DAP_PACKET_SIZE] __ALIGNED(4);  // Request  Buffer
static uint8_t  USB_Response[DAP_PACKET_COUNT][DAP_PACKET_SIZE] __ALIGNED(4);  // Response Buffer
static uint16_t USB_ResponseSize[DAP_PACKET_COUNT] __ALIGNED(4);	       // number of bytes in response
